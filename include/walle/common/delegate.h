...
public:
    ...
    static Delegate make() WALLE_NOEXCEPT 
    {
     ...
     * @retval None
     */
    explicit Delegate(R (*const function_ptr)(A...)) WALLE_NOEXCEPT
     ...
     * @retval 
     */
    static Delegate make(R (*const function_ptr)(A...)) WALLE_NOEXCEPT 
    {
    ...
    static Delegate make(C* const object_ptr) WALLE_NOEXCEPT {
    ...
    static Delegate make(C const* const object_ptr) WALLE_NOEXCEPT {
     ...
     */
    template <class C, R(C::* const Method)(A...)>
    static Delegate make(C& object) WALLE_NOEXCEPT 
    {
     ...
     */
    template <class C, R(C::* const Method)(A...) const>
    static Delegate make(C const& object) WALLE_NOEXCEPT 
    {
        return Delegate(const_method_caller<C, Method>,
                        const_cast<C*>(&object));
    }
     ...
     * @retval None
     */
    void swap(Delegate& other) WALLE_NOEXCEPT 
    { 
        std::swap(*this, other); 
    }
     ...
     * @retval None
     */
    bool operator == (Delegate const& rhs) const WALLE_NOEXCEPT 
    {
...
private:
     ...
     * @retval 
     */
    Delegate(const Caller& m, void* const obj) WALLE_NOEXCEPT
